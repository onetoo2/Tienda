...
from app.Productos.views import categorias, index, ViewProductos, nuevaCategoria,nuevoProducto, editarCategoria, editarProducto, eliminarCategoria, eliminarProducto
